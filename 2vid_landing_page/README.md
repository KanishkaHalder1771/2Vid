#
Using pm2 to run the app in the background so that the app always stays live.

Used the below command to start the server:
>> pm2 start "npm run dev" --name 2vid_frontend --watch

User helper commands : 
1) Logs : pm2 logs 2vid_frontend
2) monitor: pm2 monit

Check the website [here](https://www.npmjs.com/package/pm2) for detailed instructions 
...
[![2Vid](https://user-images.githubusercontent.com/2683512/151177673-e56ade57-c98d-4c37-b315-d313bd14bb53.png)](https://cruip.com/)
